...
- `style.css` — стили
- `logo.png` — логотип
- `hero-bg.jpg` — фон главного блока
...
## На заметку
- `hero-bg.jpg` весит ~11 МБ — это очень много для фона, страница будет грузиться медленно. Стоит сжать до ~200–400 КБ (например, через squoosh.app).
